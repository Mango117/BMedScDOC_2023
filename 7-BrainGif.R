...
setwd("/Users/manojarachige/Documents/Coding/Projects/BmedScDOC2021/BMedScDOC_Scripts/Visualisation")
library(rgl)
library(misc3d)
library(MNITemplate)
library(aal)
...
df <- read.csv(file = "/Users/manojarachige/Library/CloudStorage/Dropbox/Mac/Documents/Coding/Projects/BMedScDOC2021/BMedScDOC_2023/DisplayGif.csv", header = FALSE)
df <- df[c(1:2), ]
df <- t(df)
df <- df[-1, ]

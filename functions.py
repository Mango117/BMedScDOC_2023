...
class outputs:
    ...
    def wc(list, shape_path = "/Users/manojarachige/Documents/Coding/Projects/BMedScDOC2021/Assets/head.png", save_location = downloads_path):
        total = Counter(list).most_common()
...
class processing:
    ...
    def preprocess(string, csv_path = "/Users/manojarachige/Library/CloudStorage/Dropbox/Mac/Documents/Coding/Projects/BMedScDOC2021/BMedScDOC_2023/Dictionaries/aalbi.csv"):
